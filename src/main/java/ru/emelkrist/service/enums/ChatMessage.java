...
public enum ChatMessage {
    ...
    BOT_LOCKED_MESSAGE("На данный момент проходит техническое обслуживание.\n" +
            "Приносим извинения за неудобства, обычно этот процесс занимает несколько секунд. \n" +
            "Пожалуйста, дождитесь его окончания."),
    SCHEDULES_API_SERVER_EXCEPTION_MESSAGE("Извините, сервис для получения расписания временно недоступен.\n" +
            "Приносим извинения за причиненные неудобства, проблема уже решается."),
    SCHEDULES_API_CLIENT_EXCEPTION_MESSAGE("Извините, данная функция работает некорректно.\n" +
                                                   "Приносим извинения за причиненные неудобства, проблема уже решается.");
    private String text;
